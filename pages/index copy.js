        ...
        <div className="w-full flex flex-col md:flex-row items-start justify-between  px-20 py-20">
            ...
            <div className="md:w-[60%] w-full flex text-center">
                <div className="w-full mt-[10%]">
                    ...
                    <p className="text-grayText">
                        Do you need to research tools that can increase your
                        productivity?
                    </p>
                    <p className="text-grayText">
                        You don't have to fumble through endless feature lists
                        anymore.
                    </p>
                    <p className="text-grayText">
                        We're here to help you quickly select the right tool for
                        your project.
                    </p>
                    ...
                    <p className="text-grayText">
                        We'll provide links so you know <strong>where</strong>{" "}
                        to get each one.
                    </p>
