                ...
                <div className="w-full md:w-[75%] text-left flex flex-col">
                    <div>
                        ...
                        <p className="mb-4 text-grayText">
                            We do not collect personal information unless you
                            explicitly provide it (e.g., via contact forms). We
                            use basic analytics tools (such as Google Analytics
                            or Plausible) to understand aggregate site usage.
                        </p>
                        ...
                        <p className="mb-4 text-grayText">
                            ...
                            performance, content relevance, and user experience.
                        </p>
                        <h2 className="text-xl text-headingWhite font-semibold mb-1">
                            Third-Party Links
                        </h2>
                        <p className="mb-4 text-grayText">
                            Our site contains links to external websites, some
                            of which are affiliate partners. We are not
                        ...
                        <p className="mb-4 text-grayText">
                            You may request to access, correct, or delete any
                            personal information you've provided. Contact us at via the form listed on our Contact page.
                        </p>
                        <h2 className="text-xl text-headingWhite font-semibold mb-1">
                            Updates
                        </h2>
