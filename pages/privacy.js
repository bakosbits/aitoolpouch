            ...
            <div className="flex flex-col md:flex-row items-start gap-10">
                ...
                <div className="w-full md:w-[53%]">
                    ...
                    <p className="mb-4 text-grayText">
                        ...
                        explicitly provide it (e.g., via contact forms). We use
                        basic analytics tools (such as Google Analytics or
                    ...
                    <p className="mb-4 text-grayText">
                        Our site contains links to external websites, some of
                        which are affiliate partners. We are not responsible for
                    ...
                    <p className="mb-4 text-grayText">
                        ...
                        personal information you've provided. Contact us at
                        [your email address].
                    </p>
                    <h2 className="text-xl text-headingWhite font-semibold mt-6 mb-2">
                        Updates
