        ...
        <div className="w-full max-w-5xl mx-auto px-6 py-16">
            ...
            <ul className="space-y-6">
                {articles.map((article) => (
                    <li key={article.id} className="border border-gray-700 p-6 rounded-lg hover:bg-gray-800 transition-colors">
                        ...
                        {article.summary && <p className="text-grayText mt-2">{article.summary}</p>}
                    </li>
                ))}
            </ul>
        </div>
