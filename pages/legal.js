    ...
    <div className="w-[80%] mx-auto py-12">
      <div className="flex flex-col md:flex-row items-start gap-10">
        ...
        <div className="w-full md:w-[53%]">
          <h1 className="text-2xl text-headingWhite font-bold my-6 mb-2">Legal & Disclosures</h1>
          ...
          <h2 className="text-xl text-headingWhite font-semibold mt-6 mb-2">Disclaimer & No Guarantees</h2>
          <p className="mb-4 text-grayText">
          ...
          <h2 className="text-xl text-headingWhite font-semibold mt-6 mb-2">Privacy & Data Use</h2>
          <p className="mb-4 text-grayText">
          ...
          {/* Expanded Copyright */}
          <h2 className="text-xl text-headingWhite font-semibold mt-6 mb-2">Copyright</h2>
