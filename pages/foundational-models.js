...
export default function FoundationalModelsPage() {
  return (
      ...
      <div className="relative z-[10] max-w-4xl mx-auto w-full px-4 py-4">
        <h1 className="text-3xl font-bold mb-6">Foundational Models: Understanding the Core of Modern AI</h1>
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="h-16 flex items-center">
            <h1 className="text-3xl font-bold leading-none">1. GPT (OpenAI)</h1>
          </div>
        </div>
        ...
        <p className="mb-6">GPT is arguably the most widely recognized foundational model. Trained on a massive corpus of text, it predicts the next word in a sequence, allowing it to generate human-like responses. GPT models power a huge range of applications: customer support bots, writing assistants, coding copilots, and more.</p>
        <p className="mb-6">What makes GPT foundational is its adaptability. It can be fine-tuned or prompted to take on many different tasks without task-specific training.</p>
        <div className="flex items-center space-x-4">
          <img
          ...
          />
          <div className="h-16 flex items-center">
            <h1 className="text-3xl font-bold leading-none">2. Claude</h1>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          />
          <div className="h-16 flex items-center">
            <h1 className="text-3xl font-bold leading-none">3. Gemini (Formerly Bard)</h1>
          </div>
        </div>
        ...
        <p className="mb-6">Gemini is Google's evolution of the Bard model, designed to blend traditional language modeling with up-to-date web results. It plays a major role in Google Docs, Gmail, and search-enhanced products.</p>
        <p className="mb-6">Its core strength lies in real-time information retrieval and tight integration with existing workflows.</p>
        <div className="flex items-center space-x-4">
          <img
          ...
          />
          <div className="h-16 flex items-center">
            <h1 className="text-3xl font-bold leading-none">4. Mistral</h1>
          </div>
        </div>
        ...
        <p className="mb-6">Mistral’s open-source stance helps democratize access to cutting-edge AI without requiring a proprietary ecosystem.</p>
        <div className="flex items-center space-x-4">
          <img
            src="/logos/llama.png"
            alt="LLaMA logo"
          ...
          />
          <div className="h-16 flex items-center">
            <h1 className="text-3xl font-bold leading-none">5. LLaMA (Large Language Model Meta AI)</h1>
          </div>
        </div>
        ...
        <p className="mb-6">LLaMA models are Meta’s contribution to the open-source foundation model ecosystem. LLaMA 2, in particular, has gained traction for its balance of size, speed, and performance in many NLP tasks.</p>
        <p className="mb-6">It serves as a building block for many derivative models used in academia and lightweight commercial applications.</p>
        <div className="flex items-center space-x-4">
          <img
          ...
          />
          <div className="h-16 flex items-center">
            <h1 className="text-3xl font-bold leading-none">6. DALL-E</h1>
          </div>
        </div>
        ...
        <p className="mb-6">Unlike the others, DALL·E is a text-to-image model. It generates visual content based on written descriptions and is often used in design, illustration, and creative content workflows.</p>
        <p className="mb-6">It represents how foundational models can be multimodal, extending beyond just text to manipulate and generate images, audio, and video.</p>
