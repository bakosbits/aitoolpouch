        ...
        <>
            ...
            <div className="max-w-5xl mx-auto w-full">
                ...
                <p className="mt-4 mb-4">
                    ...
                    blend traditional language modeling with up-to-date web
                    results. It plays a major role in Google Docs, Gmail, and
                    search-enhanced products. Its core strength lies in
                    real-time information retrieval and tight integration with
                    existing workflows.
                </p>
                <div className="flex items-center space-x-4">
                <div className="w-20 h-20 rounded-full bg-white flex items-center justify-center mb-4">                      
