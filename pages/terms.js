                ...
                <div className="w-full md:w-[75%] text-left flex flex-col">
                    <div>
                        ...
                        <p className="mb-6 text-grayText">
                            By using AI Tool Pouch, you agree to the following
                        ...
                        <p className="mb-4 text-grayText">
                            ...
                            completeness, correctness, or availability of any
                        ...
                        <p className="mb-4 text-grayText">
                            You agree to use AI Tool Pouch for lawful purposes
                            only. You may not attempt to gain unauthorized
                            access to any part of the site or use our data for
                            malicious purposes.
                        </p>
                        <h2 className="text-xl text-headingWhite font-semibold mb-1">
                        ...
                        <p className="mb-4 text-grayText">
                            Some links on this site may be affiliate links. If
                            you click and make a purchase, we may earn a
