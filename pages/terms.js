            ...
            <div className="flex flex-col md:flex-row items-start gap-10">
                ...
                <div className="w-full md:w-[53%]">
                    ...
                    <p className="mb-4 text-grayText">
                        By using AI Tool Pouch, you agree to the following terms
                        and conditions.
                    </p>
                    ...
                    <p className="mb-4 text-grayText">
                        ...
                        but we make no guarantees regarding completeness,
                        correctness, or availability of any listings or data on
                        this site.
                    </p>
                    <h2 className="text-xl text-headingWhite font-semibold mt-6 mb-2">
                        Use of Site
                    ...
                    <p className="mb-4 text-grayText">
                        You agree to use AI Tool Pouch for lawful purposes only.
                        You may not attempt to gain unauthorized access to any
                        part of the site or use our data for malicious purposes.
                    </p>
                    <h2 className="text-xl text-headingWhite font-semibold mt-6 mb-2">
                        Affiliate Disclosure
                    </h2>
                    <p className="mb-4 text-grayText">
                        Some links on this site may be affiliate links. If you
                        click and make a purchase, we may earn a commission at
                    ...
                    <p className="mb-4 text-grayText">
                        ...
                        resulting from the use of this site or any tools or
