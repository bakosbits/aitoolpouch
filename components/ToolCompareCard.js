export default function ToolCompareCard({ tool }) {
    ...
    return (
        <div className="bg-cardDark p-4 rounded-md">
            ...
            <h2 className="text-xl text-headingWhite font-bold mt-6 mb-2">
                Why it matters:
            </h2>
            <p className="text-grayText mb-4">{tool.Why}</p>
            <h2 className="text-xl text-headingWhite font-bold mb-2 mt-6">
                Details:
            </h2>
            ...
            <h2 className="text-lg font-bold text-headingWhite mt-6 mb-2">
                Who's It For?
            </h2>
            <p className="text-grayText mb-4">{tool.Buyer}</p>
            {pricingList.length > 0 && (
                <div className="mt-6">
                    <h2 className="text-lg font-bold text-headingWhite mb-2">
                        Pricing Options:
                    </h2>
