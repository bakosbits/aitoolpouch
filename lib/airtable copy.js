...
function getToolsBase() {
    const { AIRTABLE_API_KEY, AIRTABLE_TOOLS_BASE_ID } =
        process.env;

    if (!AIRTABLE_API_KEY || !AIRTABLE_TOOLS_BASE_ID || !AIRTABLE_TOOLS_TABLE ||!AIRTABLE_CATEGORIES_TABLE || !AIRTABLE_ARTICLES_TABLE) {
